 ...
 {
    CMARK(0); /* For Coverage Analysis */
 }
 
 /* Generate an IMARK */
 void TestFunction (void)
 {
    CMARK(1); /* For Coverage Analysis */
 }
 ...
 word ADC_GetAvg (byte Chan)
 {
    ...
    CMARK(2); /* For Coverage Analysis */
 
    for (i = 0, Total = 0; i < ADC_Cnt; i++)
    {
       CMARK(3); /* For Coverage Analysis */
       ...
       if (ADC_Thresh[i].State != THRESH_DSBLD) /* If detection active */
       {
          ...
          switch (ADC_Thresh[i].State)
          {
             case THRESH_NULL :
                ...
                CMARK(6); /* For Coverage Analysis */
 
                if (InRange)
                {
                   CMARK(7); /* For Coverage Analysis */
             ...
             case THRESH_MAYBE_ACTV :
                ...
                CMARK(8); /* For Coverage Analysis */
 
                if (! InRange) /* If no longer active */
                {
                   CMARK(9); /* For Coverage Analysis */
                                                      ...
                                                      ADC_Thresh[i].ActvMsecs)
                {
                   ...
                   CMARK(10); /* For Coverage Analysis */
                }
             ...
             case THRESH_ACTV :
                ...
                CMARK(11); /* For Coverage Analysis */
 
                if (! InRange)
                {
                   CMARK(12); /* For Coverage Analysis */
             ...
             case THRESH_MAYBE_INACTV :
                ...
                CMARK(13); /* For Coverage Analysis */
                ...
                {
                   CMARK(14); /* For Coverage Analysis */
 ...
 {
    CMARK(15); /* For Coverage Analysis */
 ...
 {
    CMARK(16); /* For Coverage Analysis */
 ...
 {
    CMARK(17); /* For Coverage Analysis */
 ...
 void ADC_Svc (void)
 {
    CMARK(18); /* For Coverage Analysis */
    ...
    {
       CMARK(19); /* For Coverage Analysis */
    ...
    {
       CMARK(23); /* For Coverage Analysis */
       ...
       {
          CMARK(24); /* For Coverage Analysis */
    ...
    {
       CMARK(25); /* For Coverage Analysis */
    ...
    {
       CMARK(26); /* For Coverage Analysis */
 ...
 void ADC_Init (void)
 {
    CMARK(27); /* For Coverage Analysis */
    byte i;
    ...
    {
       CMARK(28); /* For Coverage Analysis */
 ...
 {
    CMARK(29); /* For Coverage Analysis */
