...
Devise.setup do |config|
  ...
  # config.secret_key = '7dafce231f71ece7a6b804b9329b1ca7de0ef6caf9fb0d4193040a7cb909eb5e6c4240f268cbcbdb93ead45d4c5a24e22a5535830d83bf2298f9f9b191157583'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'pact_cm@airworthinesscert.com'
  ...
  # config.pepper = 'cb079fec33408ff09cb387e1b8cf5f83fb230398d1c4cb17e8b09fb96ef1efa336cacacfaffa7128ba600f1eaff94a3fd0515d140772ca0ef2d5f98eaca2693c'
  ...
  # If you are seeing something like Could not authenticate you from GitHub
  # because ÒInvalid credentialsÓ you may need to add
  # ', token_params: { parse: :json }' to the end of your config.
